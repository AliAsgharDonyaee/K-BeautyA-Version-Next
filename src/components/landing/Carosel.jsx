			...
			<SwiperSlide>
				<div className='relative h-full'>
					<div className='absolute inset-0'>
						...
						/>
						<div className='pb-4 relative z-10 fec flex-col h-full bg-black bg-opacity-60'>
							...
							<div className='mt-8 w-8 xl:w-10 h-14 xl:h-16 bg-black bg-opacity-50 fcc rounded-sm animate-bounce'>
								<ArrowDownIcon className='Icon-Size text-white' />
							</div>
						</div>
					</div>
				</div>
